...
/**
 * This class provides an empty implementation of {@link BooleanArithmeticVisitor},
...
public class BooleanArithmeticBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements BooleanArithmeticVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
